---
layout: publication
title: Cloning Outfits From Real-world Images To 3D Characters For Generalizable Person
  Re-identification
authors: Yanan Wang, Xuezhi Liang, Shengcai Liao
conference: 2022 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)
year: 2022
bibkey: wang2022cloning
citations: 25
additional_links: [{name: Code, url: 'https://github.com/Yanan-Wang-cs/ClonedPerson'},
  {name: Paper, url: 'https://arxiv.org/abs/2204.02611'}]
tags: ["CVPR"]
short_authors: Yanan Wang, Xuezhi Liang, Shengcai Liao
---
