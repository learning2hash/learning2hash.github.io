...
title: 'IMAGINATOR: Pre-trained Image+text Joint Embeddings Using Word-level Grounding
  Of Images'
authors: Krishna Varuna, Suryavardan S, Mishra Shreyash, Ramamoorthy Sathyanarayanan,
  Patwa Parth, Chakraborty Megha, Chadha Aman, Das Amitava, Sheth Amit
conference: Arxiv
year: 2023
bibkey: krishna2023imaginator
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2305.10438'}]
