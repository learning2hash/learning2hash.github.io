...
authors: Xuanwu Liu, Zhao Li, Jun Wang, Guoxian Yu, Carlotta Domeniconi, Xiangliang
  Zhang
...
tags: [Evaluation, Few-shot & Zero-shot, Datasets, Memory Efficiency, Hashing Methods]
