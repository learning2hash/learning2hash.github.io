---
layout: publication
title: 'Patchrd: Detail-preserving Shape Completion By Learning Patch Retrieval And
  Deformation'
authors: Bo Sun, Vladimir G. Kim, Noam Aigerman, Qixing Huang, Siddhartha Chaudhuri
conference: Lecture Notes in Computer Science
year: 2022
bibkey: sun2022patchrd
citations: 3
additional_links: [{name: Code, url: 'https://github.com/GitBoSun/PatchRD'}, {name: Paper,
    url: 'https://arxiv.org/abs/2207.11790'}]
tags: []
short_authors: Sun et al.
---
This paper introduces a data-driven shape completion approach that focuses on
