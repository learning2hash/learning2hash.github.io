...
title: Category-level Pose Retrieval With Contrastive Features Learnt With Occlusion
  Augmentation
authors: "Kouros Georgios, Shrivastava Shubham, Picron C\xE9dric, Nagesh Sushruth,\
  \ Chakravarty Punarjay, Tuytelaars Tinne"
conference: Arxiv
year: 2022
bibkey: kouros2022category
citations: 1
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2208.06195'}]
tags: ["Distance-Metric-Learning", "Efficiency", "Image-Retrieval", "Robustness", "Datasets", "Evaluation"]
