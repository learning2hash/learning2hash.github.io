...
authors: Liu Yuting, Yang Enneng, Dang Yizhou, Guo Guibing, Liu Qiang, Liang Yuliang,
  Jiang Linying, Wang Xingwei
conference: Arxiv
year: 2023
bibkey: liu2023id
citations: 1
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2311.05956'}]
tags: ["Evaluation", "Multimodal Retrieval", "Recommender Systems", "Self-Supervised"]
