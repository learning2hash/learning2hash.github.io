...
title: Towards Low-loss 1-bit Quantization Of User-item Representations For Top-k
  Recommendation
authors: Chen Yankai, Zhang Yifei, Zhang Yingxue, Guo Huifeng, Li Jingjie, Tang Ruiming,
  He Xiuqiang, King Irwin
conference: Arxiv
year: 2021
bibkey: chen2021towards
citations: 1
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2112.01944'}]
tags: ["Efficiency", "Quantization", "Recommender Systems"]
