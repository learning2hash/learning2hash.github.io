...
authors: Bencheng Yan, Pengjie Wang, Jinquan Liu, Wei Lin, Kuang-Chih Lee, Jian Xu,
  Bo Zheng
...
tags: [CIKM, Neural Hashing, Scalability, Large-Scale Search, Recommender Systems,
  Evaluation, Compact Codes]
