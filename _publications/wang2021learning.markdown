---
layout: publication
title: 'Learning From Language Description: Low-shot Named Entity Recognition Via
...
citations: 32
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2109.05357'}]
tags: ["EMNLP"]
short_authors: Wang et al.
---
In this work, we study the problem of named entity recognition (NER) in a low
