...
authors: Tian Bing, Liu Haikun, Tang Yuhang, Xiao Shihai, Duan Zhuohui, Liao Xiaofei,
  Zhang Xuecang, Zhu Junhua, Zhang Yu
conference: Arxiv
year: 2024
bibkey: tian2024fusionanns
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2409.16576'}]
tags: ["Efficiency", "Scalability", "Large-Scale-Search", "Datasets", "Re-Ranking", "Hybrid-Ann-Methods", "Evaluation"]
