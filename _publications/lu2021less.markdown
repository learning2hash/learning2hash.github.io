...
title: 'Less Is More: Pre-train A Strong Text Encoder For Dense Retrieval Using A
  Weak Decoder'
authors: Lu Shuqi, He di, Xiong Chenyan, Ke Guolin, Malik Waleed, Dou Zhicheng, Bennett
  Paul, Liu Tieyan, Overwijk Arnold
conference: Arxiv
year: 2021
bibkey: lu2021less
citations: 2
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2102.09206'}]
tags: ["Efficiency", "Few-shot & Zero-shot", "Recommender Systems", "Text Retrieval"]
