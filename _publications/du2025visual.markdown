---
layout: publication
title: 'Visual Product Graph: Bridging Visual Products And Composite Images For End-to-end
  Style Recommendations'
authors: Yue Li Du, Ben Alexander, Mikhail Antonenka, Rohan Mahadev, Hao-Yu Wu, Dmitry
  Kislyuk
conference: Arxiv
year: 2025
bibkey: du2025visual
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2505.21454'}]
tags: ["Efficiency", "Evaluation", "Image Retrieval", "Recommender Systems"]
