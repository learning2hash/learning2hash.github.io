...
title: Towards Efficient Cross-modal Visual Textual Retrieval Using Transformer-encoder
  Deep Features
authors: "Messina Nicola, Amato Giuseppe, Falchi Fabrizio, Gennaro Claudio, Marchand-maillet\
  \ St\xE9phane"
...
tags: ["Efficiency", "Evaluation", "Multimodal Retrieval", "Transformer-based ANN"]
