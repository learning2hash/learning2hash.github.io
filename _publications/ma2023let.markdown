...
authors: Ma Zhe, Dong Jianfeng, Ji Shouling, Liu Zhenguang, Zhang Xuhong, Wang Zonghui,
  He Sifeng, Qian Feng, Zhang Xiaobo, Yang Lei
conference: Proceedings of the AAAI Conference on Artificial Intelligence
year: 2024
bibkey: ma2023let
citations: 2
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2312.09716'}]
tags: ["Efficiency", "Image-Retrieval", "AAAI", "Tools-&-Libraries", "Datasets", "Evaluation", "Video-Retrieval"]
