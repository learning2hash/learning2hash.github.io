...
authors: Jeffrey Pound, Floris Chabert, Arjun Bhushan, Ankur Goswami, Anil Pacaci,
...
tags: ["Evaluation", "Large Scale Search", "Scalability", "Similarity Search", "Vector Indexing"]
