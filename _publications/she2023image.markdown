...
authors: Rui She, Qiyu Kang, Sijie Wang, Wee Peng Tay, Yong Liang Guan, Diego Navarro
  Navarro, Andreas Hartmannsgruber
conference: IEEE Transactions on Image Processing
year: 2023
bibkey: she2023image
citations: 8
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2311.04617'}]
tags: [Efficiency, Distance Metric Learning, Graph-based ANN, Datasets, Tools & Libraries]
