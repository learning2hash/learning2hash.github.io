...
year: 2016
bibkey: lei2016comparative
citations: 114
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1604.01252'}]
tags: ["CVPR", "Recommender Systems"]
short_authors: Lei et al.
---
In many image-related tasks, learning expressive and discriminative
...
termed *hybrid* and addressed via a deep learning approach in this paper.
