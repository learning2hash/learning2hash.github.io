...
authors: Liu Haowei, Shi Yaya, Xu Haiyang, Yuan Chunfeng, Ye Qinghao, Li Chenliang,
  Yan Ming, Zhang Ji, Huang Fei, Li Bing, Hu Weiming
conference: Arxiv
year: 2024
bibkey: liu2024unifying
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2402.16769'}]
tags: ["Efficiency", "Evaluation", "Multimodal Retrieval", "Text Retrieval", "Video Retrieval"]
