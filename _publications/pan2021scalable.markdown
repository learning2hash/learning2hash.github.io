...
year: 2021
bibkey: pan2021scalable
citations: 95
additional_links: [{name: Code, url: 'https://github.com/MonashAI/HVT'}, {name: Paper,
    url: 'https://arxiv.org/abs/2103.10619'}]
tags: ["ICCV", "Scalability"]
short_authors: Pan et al.
---
The recently proposed Visual image Transformers (ViT) with pure attention
