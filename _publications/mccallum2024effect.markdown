...
authors: Mccallum Matthew C., Davies Matthew E. P., Henkel Florian, Kim Jaehun, Sandberg
  Samuel E.
conference: ICASSP 2024 - 2024 IEEE International Conference on Acoustics, Speech
  and Signal Processing (ICASSP)
year: 2024
bibkey: mccallum2024effect
citations: 2
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2401.08889'}]
tags: ["Self-Supervised", "Recommender-Systems", "ICASSP", "Datasets", "Evaluation"]
