---
layout: publication
title: "An improvement of degree-based hashing (DBH) graph partition method, using a
novel metric"
...
MSIDS (maximal sum of inner degrees squared). We establish its connection to the
replication factor (RF) optimization, which has been the main focus of
...
acceleration of GraphX-based PageRank and Label propagation algorithms.
