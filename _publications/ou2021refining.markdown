---
layout: publication
title: "Refining BERT Embeddings for Document Hashing via Mutual Information
Maximization"
...
that outperform existing ones learned from BOW features by a substantial margin.
