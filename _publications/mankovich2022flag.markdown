...
year: 2022
bibkey: mankovich2022flag
citations: 3
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2203.04437'}]
tags: ["CVPR"]
short_authors: Mankovich et al.
---
...
computing prototypes on the Grassmannian, namely, the \(ℓ₂\)-median and to
...
or \(ℓ₂\)-median on the Mind's Eye dataset.