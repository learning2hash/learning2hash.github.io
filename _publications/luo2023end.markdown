...
authors: Luo Man, Fang Zhiyuan, Gokhale Tejas, Yang Yezhou, Baral Chitta
conference: 'Proceedings of the 61st Annual Meeting of the Association for Computational
  Linguistics (Volume 1: Long Papers)'
year: 2023
bibkey: luo2023end
citations: 5
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2306.00424'}]
tags: ["Few-Shot-&-Zero-Shot", "Multimodal-Retrieval", "Datasets", "Evaluation"]
