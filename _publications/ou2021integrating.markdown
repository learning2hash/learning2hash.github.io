...
authors: Ou Zijing, Su Qinliang, Yu Jianxing, Liu Bang, Wang Jingwen, Zhao Ruihui,
  Chen Changyou, Zheng Yefeng
...
tags: ["Hashing-Methods", "Text-Retrieval", "Efficiency", "Scalability", "Memory-Efficiency", "Datasets", "Evaluation"]
