...
authors: Wang Changwei, Chen Shunpeng, Song Yukun, Xu Rongtao, Zhang Zherui, Zhang
  Jiguang, Yang Haoran, Zhang Yu, Fu Kexue, Du Shide, Xu Zhiwei, Gao Longxiang, Guo
  Li, Xu Shibiao
conference: Proceedings of the AAAI Conference on Artificial Intelligence
year: 2025
bibkey: wang2025focus
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2504.09881'}]
tags: ["AAAI", "Efficiency", "Evaluation", "Image Retrieval", "Supervised"]
