...
tags: [Compact Codes, Unsupervised, Memory Efficiency, Multimodal Retrieval, Re-ranking,
  Hybrid ANN Methods, Image Retrieval, Supervised, Hashing Methods, Graph-based ANN,
