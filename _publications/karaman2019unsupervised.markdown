...
tags: [Hybrid ANN Methods, Multimodal Retrieval, Image Retrieval, Scalability, Hashing
    Methods, Graph-based ANN, Unsupervised, Re-ranking, Memory Efficiency, Supervised,
  Datasets, Compact Codes]
