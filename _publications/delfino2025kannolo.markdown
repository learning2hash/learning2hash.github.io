...
authors: Delfino Leonardo, Erriquez Domenico, Martinico Silvio, Nardini Franco Maria,
  Rulli Cosimo, Venturini Rossano
conference: Lecture Notes in Computer Science
year: 2025
bibkey: delfino2025kannolo
citations: 1
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2501.06121'}]
tags: ["Distance Metric Learning", "Efficiency", "Evaluation", "Large-Scale Search", "Quantization", "Recommender Systems", "Scalability", "Similarity Search", "Tools & Libraries"]
