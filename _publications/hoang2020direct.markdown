---
layout: publication
title: Direct Quantization For Training Highly Accurate Low Bit-width Deep Neural
  Networks
...
conference: Proceedings of the Twenty-Ninth International Joint Conference on Artificial
  Intelligence
year: 2020
bibkey: hoang2020direct
citations: 4
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2012.13762'}]
tags: ["IJCAI", "Quantization"]
short_authors: Hoang et al.
---
This paper proposes two novel techniques to train deep convolutional neural
