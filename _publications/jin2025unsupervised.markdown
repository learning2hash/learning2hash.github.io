...
authors: Sheng Jin, Yao, Zhou, Liu, Huang, Hua
conference: IEEE Transactions on Image Processing
year: 2025
bibkey: jin2025unsupervised
citations: 16
additional_links: [{name: Paper, url: 'https://ieeexplore.ieee.org/abstract/document/9467816'}]
tags: [Compact Codes, Evaluation, Supervised, Image Retrieval, Self-Supervised, Graph-based
    ANN, Quantization, Unsupervised, Tools & Libraries, Hashing Methods]
