...
title: 'Uniadapter: Unified Parameter-efficient Transfer Learning For Cross-modal
  Modeling'
authors: Haoyu Lu, Yuqi Huo, Guoxing Yang, Zhiwu Lu, Wei Zhan, Masayoshi Tomizuka,
  Mingyu Ding
conference: Arxiv
year: 2023
bibkey: lu2023uniadapter
citations: 20
additional_links: [{name: Code, url: 'https://github.com/RERV/UniAdapter'}, {name: Paper,
    url: 'https://arxiv.org/abs/2302.06605'}]
tags: ["Image Retrieval", "Memory Efficiency", "Multimodal Retrieval", "Scalability", "Video Retrieval"]
