...
title: Efficient Match Pair Retrieval For Large-scale UAV Images Via Graph Indexed
  Global Descriptor
authors: Jiang San, Ma Yichen, Li Qingquan, Jiang Wanshou, Guo Bingxuan, Li Lelin,
  Wang Lizhe
...
tags: ["Graph-Based-Ann", "Efficiency", "Image-Retrieval", "Scalability", "Datasets", "Evaluation"]
