...
authors: Han Zhu, Long, Wang, Cao
conference: Proceedings of the AAAI Conference on Artificial Intelligence
year: 2025
bibkey: zhu2025deep
citations: 652
additional_links: [{name: Paper, url: 'http://ise.thss.tsinghua.edu.cn/~mlong/doc/deep-hashing-network-aaai16.pdf'}]
tags: [Compact Codes, Supervised, Image Retrieval, Neural Hashing, Similarity Search,
  Efficiency, Datasets, Quantization, Scalability, Unsupervised, Hashing Methods,
  AAAI]
