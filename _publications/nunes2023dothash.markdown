...
title: 'Dothash: Estimating Set Similarity Metrics For Link Prediction And Document
  Deduplication'
authors: "Nunes Igor, Heddes Mike, Verg\xE9s Pere, Abraham Danny, Veidenbaum Alexander,\
  \ Nicolau Alexandru, Givargis Tony"
...
tags: ["Distance Metric Learning", "Evaluation", "KDD", "Locality Sensitive Hashing", "Recommender Systems", "Similarity Search"]
