...
authors: Ye Zhang, Md Mustafizur Rahman, Alex Braylan, Brandon Dang, Heng-Lu Chang,
  Henna Kim, Quinten McNamara, Aaron Angert, Edward Banner, Vivek Khetan, Tyler McDonnell,
  An Thanh Nguyen, Dan Xu, Byron C. Wallace, Matthew Lease
conference: Arxiv
year: 2016
bibkey: zhang2016neural
citations: 44
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1611.06792'}]
tags: ["Survey Paper", "Text Retrieval"]
