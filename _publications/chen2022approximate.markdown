...
title: Approximate Nearest Neighbor Search Under Neural Similarity Metric For Large-scale
  Recommendation
authors: Chen Rihan, Liu Bin, Zhu Han, Wang Yaoxuan, Li Qi, Ma Buting, Hua Qingbo,
  Jiang Jun, Xu Yunlong, Deng Hongbo, Zheng Bo
...
tags: ["Datasets", "Evaluation", "Graph-Based-Ann", "CIKM", "Efficiency", "Recommender-Systems", "Robustness", "Similarity-Search", "Distance-Metric-Learning", "Scalability"]
