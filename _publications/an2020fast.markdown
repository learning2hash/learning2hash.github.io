...
title: Fast And Incremental Loop Closure Detection With Deep Features And Proximity
  Graphs
authors: An Shan, Zhu Haogang, Wei Dong, Tsintotas Konstantinos A., Gasteratos Antonios
conference: Journal of Field Robotics
year: 2022
bibkey: an2020fast
citations: 44
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2010.11703'}]
tags: ["Efficiency", "Evaluation", "Graph-based ANN", "Hashing Methods", "Scalability"]
