...
title: 'Smart Multi-modal Search: Contextual Sparse And Dense Embedding Integration
  In Adobe Express'
authors: Aroraa Cherag, King Tracy Holloway, Kumar Jayant, Lu Yi, Sharma Sanat, Srikantan
  Arvind, Uvalle David, Valls-vargas Josep, Vardhan Harsha
conference: Arxiv
year: 2024
bibkey: aroraa2024smart
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2408.14698'}]
tags: ["Efficiency", "Large-Scale Search", "Multimodal Retrieval", "Similarity Search"]
