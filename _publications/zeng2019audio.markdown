...
title: Audio-visual Embedding For Cross-modal Musicvideo Retrieval Through Supervised
  Deep CCA
authors: Zeng Donghuo, Yu Yi, Oyama Keizo
conference: Arxiv
year: 2019
bibkey: zeng2019audio
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1908.03744'}]
tags: ["Audio Retrieval", "Multimodal Retrieval", "Supervised", "Video Retrieval"]
short_authors: Zeng Donghuo, Yu Yi, Oyama Keizo
---
