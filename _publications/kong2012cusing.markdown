...
conference: NIPS
year: 2012
bibkey: kong2012cusing
additional_links:
   - {name: "PDF", url: "http://papers.nips.cc/paper/4846-isotropic-hashing.pdf"}
   - {name: "Code", url: "http://theory.stanford.edu/~weihaokong/IsoHash.zip"}
   - {name: "Poster", url: "http://theory.stanford.edu/~weihaokong/Isohash_Poster.pdf"}
---
