...
authors: Zhang Hailin, Wang Yujing, Chen Qi, Chang Ruiheng, Zhang Ting, Miao Ziming,
  Hou Yingyan, Ding Yang, Miao Xupeng, Wang Haonan, Pang Bochen, Zhan Yuefeng, Sun
  Hao, Deng Weiwei, Zhang Qi, Yang Fan, Xie Xing, Yang Mao, Cui Bin
conference: Arxiv
year: 2023
bibkey: zhang2023model
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2309.13335'}]
tags: ["Text-Retrieval", "Efficiency", "Quantization", "Vector-Indexing", "Evaluation"]
