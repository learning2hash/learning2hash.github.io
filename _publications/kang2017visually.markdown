...
year: 2017
bibkey: kang2017visually
citations: 245
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1711.02231'}]
...
show that our model can be used *generatively*, i.e., given a user and a
