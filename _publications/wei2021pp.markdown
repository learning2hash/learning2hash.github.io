...
authors: Shengyu Wei, Ruoyu Guo, Cheng Cui, Bin Lu, Shuilong Dong, Tingquan Gao, Yuning
  Du, Ying Zhou, Xueying Lyu, Qiwen Liu, Xiaoguang Hu, Dianhai Yu, Yanjun Ma
conference: Arxiv
year: 2021
bibkey: wei2021pp
citations: 6
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2111.00775'}]
tags: ["Datasets", "Distance Metric Learning", "Neural Hashing", "Quantization"]
