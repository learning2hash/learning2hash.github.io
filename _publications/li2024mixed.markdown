...
authors: Shiwei Li, Zhuoqi Hu, Xing Tang, Haozhao Wang, Shijie Xu, Weihong Luo, Yuhua
  Li, Xiuqiang He, Ruixuan Li
conference: Arxiv
year: 2024
bibkey: li2024mixed
citations: 1
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2409.20305'}]
tags: ["Compact Codes", "Datasets", "Evaluation", "Memory Efficiency", "Neural Hashing", "Quantization", "Recommender Systems", "Scalability"]
