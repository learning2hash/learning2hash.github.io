...
title: Efficient Token-guided Image-text Retrieval With Consistent Multimodal Contrastive
  Training
authors: Chong Liu, Yuqi Zhang, Hongsong Wang, Weihua Chen, Fan Wang, Yan Huang, Yi-dong
  Shen, Liang Wang
...
tags: ["Efficiency", "Image Retrieval", "Multimodal Retrieval", "Text Retrieval", "Tools & Libraries"]
