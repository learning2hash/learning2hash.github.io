...
authors: Xuexun Liu, Xiaoxu Xu, Jinlong Li, Qiudan Zhang, Xu Wang, Nicu Sebe, Lin
  Ma
conference: Arxiv
year: 2024
bibkey: liu2024less
citations: 0
additional_links: [{name: Code, url: 'https://github.com/mellody11/LESS'}, {name: Paper,
    url: 'https://arxiv.org/abs/2410.13294'}]
tags: []
short_authors: Liu et al.
---
Referring 3D Segmentation is a visual-language task that segments all points
