...
title: 'Growclip: Data-aware Automatic Model Growing For Large-scale Contrastive Language-image
  Pre-training'
authors: Xinchi Deng, Han Shi, Runhui Huang, Changlin Li, Hang Xu, Jianhua Han, James
  Kwok, Shen Zhao, Wei Zhang, Xiaodan Liang
conference: 2023 IEEE/CVF International Conference on Computer Vision (ICCV)
year: 2023
bibkey: deng2023growclip
citations: 1
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2308.11331'}]
tags: ["Few Shot & Zero Shot", "ICCV", "Image Retrieval", "Scalability"]
