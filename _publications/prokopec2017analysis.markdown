...
citations: 5
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1712.09636'}]
tags: []
short_authors: Aleksandar Prokopec
---
Ctrie is a scalable concurrent non-blocking dictionary data structure, with
