...
additional_links: [{name: Paper, url: 'http://media.cs.tsinghua.edu.cn/~multimedia/cuipeng/papers/HeterogeneousHashing.pdf'}]
tags: [Multi-Modal Hashing, Hashing Methods, Applications, Evaluation Metrics, Benchmarks
    and Datasets]
---
