...
authors: Yabing Wang, Jianfeng Dong, Tianxiang Liang, Minsong Zhang, Rui Cai, Xun
  Wang
...
tags: [Tree-based ANN, Evaluation, Supervised, Datasets, Robustness, Multimodal Retrieval,
