...
authors: Kim Jae Myung, Koepke A. Sophia, Schmid Cordelia, Akata Zeynep
conference: 2023 IEEE/CVF Conference on Computer Vision and Pattern Recognition Workshops
  (CVPRW)
year: 2023
bibkey: kim2023exposing
citations: 15
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2304.03391'}]
tags: ["Text-Retrieval", "CVPR", "Robustness", "Multimodal-Retrieval", "Evaluation"]
