...
authors: Zeren Sun, Yazhou Yao, Xiu-Shen Wei, Yongshun Zhang, Fumin Shen, Jianxin
  Wu, Jian Zhang, Heng-Tao Shen
conference: 2021 IEEE/CVF International Conference on Computer Vision (ICCV)
year: 2021
bibkey: sun2021webly
citations: 50
additional_links: [{name: Code, url: 'https://github.com/NUST-Machine-Intelligence-Laboratory/weblyFG-dataset\'},
  {name: Paper, url: 'https://arxiv.org/abs/2108.02399'}]
tags: ["Datasets", "Evaluation", "ICCV", "Supervised"]
short_authors: Sun et al.
---
Learning from the web can ease the extreme dependence of deep learning on
