...
title: 'Arkade: K-nearest Neighbor Search With Non-euclidean Distances Using GPU Ray
  Tracing'
authors: Mandarapu Durga, Nagarajan Vani, Pelenitsyn Artem, Kulkarni Milind
...
tags: ["Distance Metric Learning", "Efficiency", "Evaluation", "Large-Scale Search", "Similarity Search", "Tree-based ANN"]
