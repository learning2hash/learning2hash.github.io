---
layout: publication
title: Similarity-based Android Malware Detection Using Hamming Distance Of Static
  Binary Features
authors: Rahim Taheri, Meysam Ghahramani, Reza Javidan, Mohammad Shojafar, Zahra Pooranian,
  Mauro Conti
