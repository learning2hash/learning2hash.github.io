...
authors: Islam Md. Farhadul, Reza Md. Tanzim, Manab Meem Arafat, Mahin Mohammad Rakibul
  Hasan, Zabeen Sarah, Noor Jannatun
conference: Arxiv
year: 2024
bibkey: islam2024spatially
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2404.06593'}]
tags: ["Compact Codes", "Distance Metric Learning", "Efficiency", "Memory Efficiency", "Similarity Search"]
