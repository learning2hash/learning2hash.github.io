...
authors: Nan Zhang, Prafulla Kumar Choubey, Alexander Fabbri, Gabriel Bernadett-Shapiro,
  Rui Zhang, Prasenjit Mitra, Caiming Xiong, Chien-Sheng Wu
conference: Arxiv
year: 2024
bibkey: zhang2024sirerag
citations: 0
additional_links: [{name: Code, url: 'https://github.com/SalesforceAIResearch/SiReRAG'},
  {name: Paper, url: 'https://arxiv.org/abs/2412.06206'}]
tags: []
