...
title: 'Arnet: Self-supervised FG-SBIR With Unified Sample Feature Alignment And Multi-scale
  Token Recycling'
authors: Jiang Jianan, Tang Hao, Jiang Zhilin, Yu Weiren, Wu di
conference: Proceedings of the AAAI Conference on Artificial Intelligence
year: 2025
bibkey: jiang2024arnet
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2406.11551'}]
tags: ["Self-Supervised", "Distance-Metric-Learning", "Scalability", "Image-Retrieval", "AAAI", "Tools-&-Libraries", "Datasets", "Supervised", "Evaluation"]
