...
authors: Zheng Zhang, Li Liu, Jie Qin, Fan Zhu, Fumin Shen, Yong Xu, Ling Shao, Heng
  Tao Shen
...
tags: ["Datasets", "Distance Metric Learning", "Hashing Methods", "Memory Efficiency", "Scalability"]
