...
title: 'Beyond Two-tower Matching: Learning Sparse Retrievable Cross-interactions
  For Recommendation'
authors: Su Liangcai, Yan Fan, Zhu Jieming, Xiao Xi, Duan Haoyi, Zhao Zhou, Dong Zhenhua,
  Tang Ruiming
...
tags: ["Efficiency", "Recommender-Systems", "Similarity-Search", "SIGIR", "Tools-&-Libraries", "Datasets", "Evaluation"]
