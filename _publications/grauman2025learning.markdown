...
tags: [Compact Codes, Supervised, Image Retrieval, Survey Paper, Distance Metric Learning,
  Scalability, Unsupervised, Large-Scale Search, Hashing Methods, Locality Sensitive
    Hashing]
