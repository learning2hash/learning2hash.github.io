---
layout: publication
title: 'Locality-sensitive Hashing For Earthquake Detection: A Case Study Of Scaling
  Data-driven Science'
authors: Kexin Rong, Yoon, Bergen, Elezabi, Peter Bailis, Levis, Beroza
conference: No Venue
year: 2018
bibkey: rong2018locality
citations: 6
additional_links: [{name: Paper, url: 'http://www.vldb.org/pvldb/vol11/p1674-rong.pdf'}]
tags: [Efficiency, Hashing Methods, Re-ranking, Locality Sensitive Hashing, Scalability]
