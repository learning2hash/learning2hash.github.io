...
authors: Junyu Luo, Yusheng Zhao, Xiao Luo, Zhiping Xiao, Wei Ju, Li Shen, Dacheng
  Tao, Ming Zhang
...
tags: [Evaluation, Supervised, Efficiency, Memory Efficiency, Unsupervised, Hashing
    Methods]
