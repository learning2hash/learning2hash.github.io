...
authors: Siwei Wu, Yizhi Li, Kang Zhu, Ge Zhang, Yiming Liang, Kaijing Ma, Chenghao
  Xiao, Haoran Zhang, Bohao Yang, Wenhu Chen, Wenhao Huang, Noura Al Moubayed, Jie
  Fu, Chenghua Lin
conference: Arxiv
year: 2024
bibkey: wu2024scimmir
citations: 0
additional_links: [{name: Code, url: 'https://github.com/Wusiwei0410/SciMMIR'}, {
    name: Paper, url: 'https://arxiv.org/abs/2401.13478'}]
tags: ["Evaluation"]
