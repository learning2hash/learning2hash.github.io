...
authors: Leqi Shen, Tianxiang Hao, Tao He, Sicheng Zhao, Yifeng Zhang, Pengzhang Liu,
  Yongjun Bao, Guiguang Ding
conference: Arxiv
year: 2024
bibkey: shen2024tempme
citations: 0
additional_links: [{name: Code, url: 'https://github.com/LunarShen/TempMe'}, {name: Paper,
    url: 'https://arxiv.org/abs/2409.01156'}]
tags: ["Efficiency", "Memory Efficiency", "Video Retrieval"]
