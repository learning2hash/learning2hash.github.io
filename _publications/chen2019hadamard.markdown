...
authors: Chen Shen, Cao Liujuan, Lin Mingbao, Wang Yan, Sun Xiaoshuai, Wu Chenglin,
  Qiu Jingfei, Ji Rongrong
conference: Arxiv
year: 2019
bibkey: chen2019hadamard
citations: 3
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1910.09182'}]
tags: ["Hashing-Methods", "Neural-Hashing", "Compact-Codes", "Efficiency", "Scalability", "Image-Retrieval", "Supervised", "Evaluation"]
