...
authors: Sara Ghazanfari, Alexandre Araujo, Prashanth Krishnamurthy, Farshad Khorrami,
  Siddharth Garg
conference: Arxiv
year: 2023
bibkey: ghazanfari2023lipsim
citations: 1
additional_links: [{name: Code, url: 'https://github.com/SaraGhazanfari/LipSim'},
  {name: Paper, url: 'https://arxiv.org/abs/2310.18274'}]
tags: [Evaluation, Image Retrieval, Distance Metric Learning, Robustness, Tools &
    Libraries]
...
\(ℓ₂\) ball. Finally, a comprehensive set of experiments shows the
