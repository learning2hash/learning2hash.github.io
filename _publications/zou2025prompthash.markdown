...
title: 'Prompthash: Affinity-prompted Collaborative Cross-modal Learning For Adaptive
  Hashing Retrieval'
authors: Zou Qiang, Cheng Shuli, Chen Jiayi
conference: Proceedings of the 2018 ACM on International Conference on Multimedia
  Retrieval
year: 2025
bibkey: zou2025prompthash
citations: 7
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2503.16064'}]
tags: [DATASETS, Evaluation, Hashing Methods, Efficiency And Optimization, Image Retrieval,
  Tools & Libraries, Multimodal Retrieval]
---
