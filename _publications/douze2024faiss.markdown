...
authors: "Douze Matthijs, Guzhva Alexandr, Deng Chengqi, Johnson Jeff, Szilvasy Gergely,\
  \ Mazar\xE9 Pierre-emmanuel, Lomeli Maria, Hosseini Lucas, J\xE9gou Herv\xE9"
conference: Arxiv
year: 2024
bibkey: douze2024faiss
citations: 17
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2401.08281'}]
tags: ["Tools-&-Libraries", "Evaluation", "Similarity-Search"]
