---
layout: publication
title: 'M2-RAAP: A Multi-modal Recipe For Advancing Adaptation-based Pre-training
  Towards Effective And Efficient Zero-shot Video-text Retrieval'
authors: Xingning Dong, Zipeng Feng, Chunluan Zhou, Xuzheng Yu, Ming Yang, Qingpei
  Guo
conference: Arxiv
year: 2024
bibkey: dong2024m2
citations: 0
additional_links: [{name: Code, url: 'https://github.com/alipay/Ant-Multi-Modal-Framework/tree/main/prj/M2_RAAP'},
  {name: Paper, url: 'https://arxiv.org/abs/2401.17797'}]
tags: [Evaluation, Few-shot & Zero-shot, Datasets, Robustness, Tools & Libraries,
  Text Retrieval]
