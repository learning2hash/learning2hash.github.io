...
tags: [Tree-based ANN, Evaluation, Re-ranking, Efficiency, Similarity Search, Datasets,
  Tools & Libraries, Text Retrieval, Hybrid ANN Methods]
short_authors: Haike Xu, Sandeep Silwal, Piotr Indyk
---
