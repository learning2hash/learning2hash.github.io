...
tags: ["CIKM", "Efficiency", "Evaluation", "Large-Scale Search", "Quantization", "Similarity Search"]
...
further brings 10x speedup on CPU and 2x speedup on GPU in query latency.