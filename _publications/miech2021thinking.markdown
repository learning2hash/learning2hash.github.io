...
authors: Miech Antoine, Alayrac Jean-baptiste, Laptev Ivan, Sivic Josef, Zisserman
  Andrew
...
tags: ["CVPR", "Efficiency", "Image Retrieval", "Multimodal Retrieval", "Scalability", "Similarity Search", "Text Retrieval", "Transformer-based ANN"]
