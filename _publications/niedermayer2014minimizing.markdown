...
tags: ['ARXIV']
---
To increase the computational efficiency of interest-point based object
...
therefore lead to increased efficiency. As this reduction of kNN queries reduces
the number of tentative correspondences, a loss of query precision is minimized
by an additional image-level correspondence generation stage with a
