...
authors: Reuben Tan, Bryan A. Plummer, Kate Saenko, Jp Lewis, Avneesh Sud, Thomas
  Leung
conference: Lecture Notes in Computer Science
year: 2022
bibkey: tan2022newsstories
citations: 2
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2207.13061'}]
tags: ["Datasets"]
short_authors: Tan et al.
---
Recent self-supervised approaches have used large-scale image-text datasets
