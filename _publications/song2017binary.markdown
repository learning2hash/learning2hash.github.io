...
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1708.04150'}, {name: Code,
    url: 'https://github.com/htconquer/BGAN'}]
tags: [Applications, Unsupervised, Deep Hashing, Tools and Libraries, Evaluation Metrics,
  Supervised, Benchmarks and Datasets, Hashing Methods, Has Code]
---
