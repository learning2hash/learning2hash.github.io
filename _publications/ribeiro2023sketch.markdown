...
title: 'Sketch-an-anchor: Sub-epoch Fast Model Adaptation For Zero-shot Sketch-based
  Image Retrieval'
authors: Ribeiro Leo Sampaio Ferraz, Ponti Moacir Antonelli
conference: Arxiv
year: 2023
bibkey: ribeiro2023sketch
citations: 2
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2303.16769'}]
tags: ["Distance-Metric-Learning", "Few-Shot-&-Zero-Shot", "Image-Retrieval", "Datasets", "Evaluation"]
short_authors: Ribeiro Leo Sampaio Ferraz, Ponti Moacir Antonelli
---
