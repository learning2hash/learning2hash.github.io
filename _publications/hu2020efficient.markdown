...
high-dimensional spaces. We propose a novel method, WLSH, to address the problem
for the \$l_p\$ distance for \$p\in(0,2]\$. WLSH takes the LSH approach and can
theoretically guarantee both the efficiency of processing queries and the
