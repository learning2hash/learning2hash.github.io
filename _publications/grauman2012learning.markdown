...
tags: [Survey Paper, Compact Codes, Large-Scale Search, Hashing Methods, Supervised,
  Locality Sensitive Hashing, Unsupervised, Scalability, Distance Metric Learning,
  Image Retrieval]
