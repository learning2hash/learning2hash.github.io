...
tags: ["Compact Codes", "Distance Metric Learning", "Hashing Methods", "Image Retrieval", "Large Scale Search", "Locality Sensitive Hashing", "Scalability", "Supervised", "Unsupervised"]
