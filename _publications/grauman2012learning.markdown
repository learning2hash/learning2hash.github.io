...
tags: [Scalability, Image Retrieval, Supervised, Hashing Methods, Locality Sensitive
    Hashing, Compact Codes, Distance Metric Learning, Large-Scale Search, Unsupervised,
  Survey Paper]
