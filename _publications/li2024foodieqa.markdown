...
title: 'Foodieqa: A Multimodal Dataset For Fine-grained Understanding Of Chinese Food
  Culture'
authors: "Wenyan Li, Xinyu Zhang, Jiaang Li, Qiwei Peng, Raphael Tang, Li Zhou, Weijia\
  \ Zhang, Guimin Hu, Yifei Yuan, Anders S\xF8gaard, Daniel Hershcovich, Desmond Elliott"
conference: Proceedings of the 2024 Conference on Empirical Methods in Natural Language
  Processing
year: 2024
bibkey: li2024foodieqa
citations: 1
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2406.11030'}]
tags: ["Datasets"]
