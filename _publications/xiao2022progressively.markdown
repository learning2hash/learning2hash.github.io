...
title: Progressively Optimized Bi-granular Document Representation For Scalable Embedding
  Based Retrieval
authors: Xiao Shitao, Liu Zheng, Han Weihao, Zhang Jianjin, Shao Yingxia, Lian Defu,
  Li Chaozhuo, Sun Hao, Deng Denvy, Zhang Liangjie, Zhang Qi, Xie Xing
conference: Proceedings of the ACM Web Conference 2022
year: 2022
bibkey: xiao2022progressively
citations: 14
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2201.05409'}]
tags: ["Quantization", "Vector-Indexing", "Scalability", "Tools-&-Libraries", "Large-Scale-Search", "Evaluation"]
