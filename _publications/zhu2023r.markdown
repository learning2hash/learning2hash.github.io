...
title: '\(r^{2}\)former: Unified \(r\)etrieval And \(r\)eranking Transformer For Place
  Recognition'
authors: Zhu Sijie, Yang Linjie, Chen Chen, Shah Mubarak, Shen Xiaohui, Wang Heng
conference: Arxiv
year: 2023
bibkey: zhu2023r
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2304.03410'}]
tags: ["Image Retrieval", "Multimodal Retrieval", "Re-ranking", "Scalability", "Text Retrieval", "Tools & Libraries", "Transformer-based ANN"]
