...
title: 'Zero In On Shape: A Generic 2D-3D Instance Similarity Metric Learned From
  Synthetic Data'
authors: Janik Maciej, Gard Niklas, Hilsmann Anna, Eisert Peter
...
tags: ["Distance Metric Learning", "Evaluation", "Few-shot & Zero-shot", "Image Retrieval", "Similarity Search"]
