...
authors: Zhao Kang, Pan Pan, Zheng Yun, Zhang Yanhao, Wang Changxu, Zhang Yingya,
  Xu Yinghui, Jin Rong
...
tags: ["Graph-Based-Ann", "CIKM", "Efficiency", "Scalability", "Image-Retrieval", "Large-Scale-Search", "Compact-Codes", "Evaluation"]
