...
authors: Luo Xiao, Wang Haixin, Wu Daqing, Chen Chong, Deng Minghua, Huang Jianqiang,
  Hua Xian-sheng
conference: ACM Transactions on Knowledge Discovery from Data
year: 2022
bibkey: luo2020survey
citations: 123
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2003.03369'}]
tags: ["Survey-Paper", "Self-Supervised", "Hashing-Methods", "Neural-Hashing", "Efficiency", "Quantization", "Datasets", "Supervised", "Evaluation", "Unsupervised"]
