...
bibkey: amr2010using
additional_links:
   - {name: "Report", url: "Journal of Computer Science, ISSN 19475500"}
   - {name: "License", url: "http://arxiv.org/licenses/nonexclusive-distrib/1.0/"}
   - {name: "Paper", url: "https://arxiv.org/abs/1002.2193"}
tags: ['International Journal of Computer Science and Information Security, IJCSIS, Vol.', 'IJCSIS', 'TOM', 'Image Retrieval']
---
