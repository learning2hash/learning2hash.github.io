...
title: Embedding Compression With Hashing For Efficient Representation Learning In
  Large-scale Graph
authors: Yeh Chin-chia Michael, Gu Mengting, Zheng Yan, Chen Huiyuan, Ebrahimi Javid,
  Zhuang Zhongfang, Wang Junpeng, Wang Liang, Zhang Wei
...
tags: ["Graph-Based-Ann", "Hashing-Methods", "Scalability", "Evaluation", "KDD"]
