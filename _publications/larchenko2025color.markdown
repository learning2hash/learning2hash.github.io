...
authors: Maria Larchenko, Alexander Lobashev, Dmitry Guskov, Vladimir Vladimirovich
  Palyulin
conference: Proceedings of the AAAI Conference on Artificial Intelligence
year: 2025
bibkey: larchenko2025color
citations: 0
additional_links: [{name: Code, url: 'https://github.com/maria-larchenko/modflows'},
  {name: Paper, url: 'https://arxiv.org/abs/2503.19062'}]
tags: ["AAAI"]
short_authors: Larchenko et al.
---
