...
citations: 0
additional_links: [{name: Code, url: 'https://github.com/movinghoon/dtem\}\{link\'},
  {name: Paper, url: 'https://arxiv.org/abs/2412.10569'}]
tags: ["Efficiency", "Transformer Based ANN"]
short_authors: Dong Hoon Lee, Seunghoon Hong
---
Recent token reduction methods for Vision Transformers (ViTs) incorporate
