...
authors: Tasawong Panuthep, Ponwitayarat Wuttikorn, Limkonchotiwat Peerat, Udomcharoenchaikit
  Can, Chuangsuwanich Ekapol, Nutanong Sarana
conference: 'Proceedings of the 61st Annual Meeting of the Association for Computational
  Linguistics (Volume 2: Short Papers)'
year: 2023
bibkey: tasawong2023typo
citations: 2
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2306.10348'}]
tags: ["Evaluation", "Robustness", "Text Retrieval"]
