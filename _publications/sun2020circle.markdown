...
authors: Sun Yifan, Cheng Changmao, Zhang Yuhan, Zhang Chi, Zheng Liang, Wang Zhongdao,
  Wei Yichen
...
tags: ["Distance-Metric-Learning", "CVPR", "Image-Retrieval", "Datasets", "Evaluation"]
