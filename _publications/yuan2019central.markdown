...
authors: Yuan Li, Wang Tao, Zhang Xiaopeng, Tay Francis Eh, Jie Zequn, Liu Wei, Feng
  Jiashi
conference: 2020 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)
year: 2020
bibkey: yuan2019central
citations: 288
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1908.00347'}]
tags: ["CVPR", "Distance Metric Learning", "Efficiency", "Hashing Methods", "Image Retrieval", "Quantization", "Scalability", "Video Retrieval"]
...
In this work, we propose a new *global* similarity metric, termed as
*central similarity*, with which the hash codes of similar data pairs are
...
central similarity metric by introducing a new concept, i.e., *hash
...
is at: https://github.com/yuanli2333/Hadamard-Matrix-for-hashing