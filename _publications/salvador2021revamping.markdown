---
layout: publication
title: Revamping Cross-modal Recipe Retrieval With Hierarchical Transformers And Self-supervised
  Learning
authors: Salvador Amaia, Gundogdu Erhan, Bazzani Loris, Donoser Michael
conference: 2021 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)
year: 2021
bibkey: salvador2021revamping
citations: 61
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2103.13061'}]
tags: ["CVPR", "Datasets", "Evaluation", "Multimodal Retrieval", "Self-Supervised", "Transformer-based ANN"]
