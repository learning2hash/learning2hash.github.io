...
authors: Song Liu, Qian, Guan, Zhan, Ying
...
tags: [Efficiency, Compact Codes, Hashing Methods, SIGIR, Datasets, Multimodal Retrieval,
  Unsupervised, Scalability, Evaluation]
