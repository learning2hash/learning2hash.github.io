...
title: Pairwise Supervised Hashing With Bernoulli Variational Auto-encoder And Self-control
  Gradient Estimator
authors: Dadaneh Siamak Zamani, Boluki Shahin, Yin Mingzhang, Zhou Mingyuan, Qian
  Xiaoning
...
tags: ["Hashing-Methods", "Neural-Hashing", "Text-Retrieval", "Similarity-Search", "Scalability", "Tools-&-Libraries", "Supervised", "Evaluation"]
