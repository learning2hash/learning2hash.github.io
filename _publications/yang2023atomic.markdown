...
title: 'Atomic: An Image/text Retrieval Test Collection To Support Multimedia Content
  Creation'
authors: "Yang Jheng-hong, Lassance Carlos, de Rezende Rafael Sampaio, Srinivasan\
  \ Krishna, Redi Miriam, Clinchant St\xE9phane, Lin Jimmy"
conference: Proceedings of the 46th International ACM SIGIR Conference on Research
  and Development in Information Retrieval
year: 2023
bibkey: yang2023atomic
citations: 4
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2304.01961'}]
tags: ["Datasets", "Image Retrieval", "Multimodal Retrieval", "SIGIR", "Text Retrieval"]
