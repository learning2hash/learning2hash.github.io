...
citations: 4
additional_links: [{name: Code, url: 'https://github.com/TREC-AToMiC/AToMiC.'}, {
    name: Paper, url: 'https://arxiv.org/abs/2304.01961'}]
tags: [Text Retrieval, SIGIR, Datasets, Multimodal Retrieval, Scalability]
