...
authors: Runhui Wang, Luyang Kong, Yefan Tao, Andrew Borthwick, Davor Golac, Henrik
  Johnson, Shadie Hijazi, Dong Deng, Yongfeng Zhang
...
tags: [Hashing Methods, Datasets, Supervised, Locality Sensitive Hashing, Scalability,
  Evaluation, Distance Metric Learning]
