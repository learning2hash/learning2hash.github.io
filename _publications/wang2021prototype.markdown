...
additional_links:
   - {name: "PDF", url: "https://openaccess.thecvf.com/content/CVPR2021/papers/Wang_Prototype-Supervised_Adversarial_Network_for_Targeted_Attack_of_Deep_Hashing_CVPR_2021_paper.pdf"}
   - {name: "URL", url: "https://openaccess.thecvf.com/content/CVPR2021/html/Wang_Prototype-Supervised_Adversarial_Network_for_Targeted_Attack_of_Deep_Hashing_CVPR_2021_paper.html"}
   - {name: "Code", url: "https://github.com/xunguangwang/ProS-GAN"}
tags: ["CVPR","Deep Learning","Supervised","Has Code"]
---
