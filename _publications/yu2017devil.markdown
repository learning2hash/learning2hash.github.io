...
title: 'The Devil Is In The Middle: Exploiting Mid-level Representations For Cross-domain
  Instance Matching'
authors: Yu Qian, Chang Xiaobin, Song Yi-zhe, Xiang Tao, Hospedales Timothy M.
conference: Arxiv
year: 2017
bibkey: yu2017devil
citations: 74
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1711.08106'}]
tags: ["Distance Metric Learning", "Efficiency", "Image Retrieval", "Scalability", "Similarity Search"]
