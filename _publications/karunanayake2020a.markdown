...
authors: Naveen Karunanayake, Jathushan Rajasegaran, Ashanie Gunathillake, Suranga
  Seneviratne, Guillaume Jourjon
...
tags: [Neural Hashing, Datasets, Image Retrieval, Hashing Methods, Evaluation]
