...
authors: Haicheng Wang, Chen Ju, Weixiong Lin, Shuai Xiao, Mengting Chen, Yixuan Huang,
  Chang Liu, Mingshuai Yao, Jinsong Lan, Ying Chen, Qingwen Liu, Yanfeng Wang
conference: Arxiv
year: 2024
bibkey: wang2024advancing
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2412.00440'}]
tags: ["Multimodal Retrieval", "Scalability", "Self-Supervised"]
