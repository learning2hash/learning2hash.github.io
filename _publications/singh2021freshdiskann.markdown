...
title: 'Freshdiskann: A Fast And Accurate Graph-based ANN Index For Streaming Similarity
  Search'
authors: Aditi Singh, Suhas Jayaram Subramanya, Ravishankar Krishnaswamy, Harsha Vardhan
  Simhadri
conference: Arxiv
year: 2021
...
tags: [Datasets, Efficiency, Vector Indexing, Similarity Search, Evaluation, Graph-based
    ANN]
