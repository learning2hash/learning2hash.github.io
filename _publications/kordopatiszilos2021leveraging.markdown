...
title: Leveraging Efficientnet And Contrastive Learning For Accurate Global-scale
  Location Estimation
authors: Kordopatis-zilos Giorgos, Galopoulos Panagiotis, Papadopoulos Symeon, Kompatsiaris
  Ioannis
...
tags: ["Efficiency", "Image Retrieval", "Large-Scale Search", "Multimodal Retrieval", "Self-Supervised"]
