...
title: Fine-grained Embedding Dimension Optimization During Training For Recommender
  Systems
authors: Luo Qinyi, Wang Penghan, Zhang Wei, Lai Fan, Mao Jiachen, Wei Xiaohan, Song
  Jun, Tsai Wei-yu, Yang Shuai, Hu Yuxi, Qian Xuehai
conference: Arxiv
year: 2024
bibkey: luo2024fine
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2401.04408'}]
tags: ["Memory-Efficiency", "Recommender-Systems", "Datasets"]
