...
authors: Li Haitao, Ai Qingyao, Zhan Jingtao, Mao Jiaxin, Liu Yiqun, Liu Zheng, Cao
  Zhao
...
tags: ["Efficiency", "Evaluation", "Large-Scale Search", "SIGIR", "Similarity Search", "Tree-based ANN", "Vector Indexing"]
