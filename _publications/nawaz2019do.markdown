...
authors: Nawaz Shah, Janjua Muhammad Kamran, Gallo Ignazio, Mahmood Arif, Calefati
  Alessandro, Shafait Faisal
...
tags: ["ICCV", "Multimodal-Retrieval", "Evaluation", "Datasets"]
