...
conference: Arxiv
year: 2019
bibkey: suzuki2019shamfinder
citations: 5
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1909.07539'}]
tags: ["Tools & Libraries"]
short_authors: Suzuki et al.
---
The internationalized domain name (IDN) is a mechanism that enables us to use
