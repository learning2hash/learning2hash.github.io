---
layout: publication
title: Fast Feature Matching Of UAV Images Via Matrix Band Reduction-based GPU Data
  Schedule
...
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2505.22089'}]
tags: [Applications, Tools and Libraries, Indexing, ANN Search, Efficient Learning,
  Hashing Methods]
---
