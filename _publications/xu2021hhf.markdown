...
authors: Xu Chengyin, Chai Zenghao, Xu Zhengzhuo, Li Hongjia, Zuo Qiruyi, Yang Lingyu,
  Yuan Chun
conference: IEEE Transactions on Multimedia
year: 2022
bibkey: xu2021hhf
citations: 16
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2112.02225'}]
tags: ["Hashing-Methods", "Distance-Metric-Learning", "Neural-Hashing", "Quantization", "Scalability", "Image-Retrieval", "Evaluation"]
