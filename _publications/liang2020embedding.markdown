...
authors: Davis Liang, Peng Xu, Siamak Shakeri, Cicero Nogueira Dos Santos, Ramesh
  Nallapati, Zhiheng Huang, Bing Xiang
conference: Arxiv
year: 2020
bibkey: liang2020embedding
citations: 23
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2009.10270'}]
tags: [Efficiency, Few-shot & Zero-shot, Datasets, Evaluation]
