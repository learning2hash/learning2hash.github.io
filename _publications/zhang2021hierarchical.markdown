...
authors: Yongfei Zhang, Cheng Peng, Zhang Jingtao, Xianglong Liu, Shiliang Pu, Changhuai
  Chen
conference: 2020 25th International Conference on Pattern Recognition (ICPR)
year: 2021
bibkey: zhang2021hierarchical
citations: 2
additional_links: [{name: Paper, url: 'https://ailb-web.ing.unimore.it/icpr/author/4095'}]
tags: ["Datasets", "Efficiency", "Evaluation", "Hashing Methods", "Image Retrieval", "Neural Hashing"]
