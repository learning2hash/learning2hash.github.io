...
title: 'SCOT: Self-supervised Contrastive Pretraining For Zero-shot Compositional
  Retrieval'
authors: Jawade Bhavin, Soares Joao V. B., Thadani Kapil, Mohan Deen Dayal, Eshratifar
  Amir Erfan, Culpepper Benjamin, de Juan Paloma, Setlur Srirangaraj, Govindaraju
  Venu
conference: Arxiv
year: 2025
...
tags: ["Self-Supervised", "Few-Shot-&-Zero-Shot", "Image-Retrieval", "Scalability", "Datasets", "Supervised"]
