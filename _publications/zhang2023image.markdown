...
additional_links:
  - {name: "Paper", url: "https://arxiv.org/abs/2304.10254"}
  - {name: "Code", url: "https://github.com/ZhangXu0963/VSL."}
tags: ['ARXIV', 'Cross Modal', 'Text Retrieval']
---
Image-text retrieval is one of the major tasks of cross-modal retrieval. Several
approaches for this task map images and texts into a common space to create
correspondences between the two modalities. However, due to the content
