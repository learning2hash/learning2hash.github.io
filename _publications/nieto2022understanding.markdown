---
layout: publication
title: 'Understanding Aesthetics With Language: A Photo Critique Dataset For Aesthetic
  Assessment'
authors: Daniel Vera Nieto, Luigi Celona, Clara Fernandez-Labrador
conference: Arxiv
year: 2022
bibkey: nieto2022understanding
citations: 3
additional_links: [{name: Code, url: 'https://github.com/mediatechnologycenter/aestheval)'},
  {name: Paper, url: 'https://arxiv.org/abs/2206.08614'}]
tags: ["Datasets"]
short_authors: Daniel Vera Nieto, Luigi Celona, Clara Fernandez-Labrador
---
