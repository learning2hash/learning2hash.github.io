...
title: Fine-grained Visual Textual Alignment For Cross-modal Retrieval Using Transformer
  Encoders
authors: "Messina Nicola, Amato Giuseppe, Esuli Andrea, Falchi Fabrizio, Gennaro Claudio,\
  \ Marchand-maillet St\xE9phane"
...
tags: ["Image-Retrieval", "Scalability", "Multimodal-Retrieval", "Datasets", "Evaluation"]
