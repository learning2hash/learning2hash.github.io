...
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1604.03499'}]
tags: [ARXIV, Quantisation, Efficiency and Optimization]
---
We investigate the sign-linear embeddings of 1-bit compressed sensing given
...
an RIP when the metric on the sphere is given by the noise.