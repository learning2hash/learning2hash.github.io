...
authors: Jinpeng Wang, Bin Chen, Dongliang Liao, Ziyun Zeng, Gongfu Li, Shu-tao Xia,
  Jin Xu
...
tags: ["Datasets", "Efficiency", "Evaluation", "Quantization", "Robustness", "Scalability", "Self-Supervised", "Video Retrieval"]
