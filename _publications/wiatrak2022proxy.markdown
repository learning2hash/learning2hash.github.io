...
conference: Proceedings of the 13th International Workshop on Health Text Mining and
  Information Analysis (LOUHI)
year: 2022
bibkey: wiatrak2022proxy
citations: 1
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2301.13318'}]
tags: [Few-shot & Zero-shot, Evaluation, ALT, Robustness, Distance Metric Learning]
