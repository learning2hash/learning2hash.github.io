...
authors: Kevin Lin, Yang, Hsiao, Chen
...
tags: [Compact Codes, Image Retrieval, Hashing Methods, Datasets, Supervised, Scalability,
  Tools & Libraries, CVPR, Neural Hashing]
