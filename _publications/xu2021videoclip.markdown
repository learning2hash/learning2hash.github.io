...
authors: Xu Hu, Ghosh Gargi, Huang Po-yao, Okhonko Dmytro, Aghajanyan Armen, Metze
  Florian, Zettlemoyer Luke, Feichtenhofer Christoph
conference: Proceedings of the 2021 Conference on Empirical Methods in Natural Language
  Processing
year: 2021
bibkey: xu2021videoclip
citations: 266
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2109.14084'}]
tags: ["EMNLP", "Few-Shot-&-Zero-Shot", "Supervised", "Evaluation", "Video-Retrieval"]
