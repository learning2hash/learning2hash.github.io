---
layout: publication
title: 'Detection Hub: Unifying Object Detection Datasets Via Query Adaptation On
  Language Embedding'
authors: Lingchen Meng, Xiyang Dai, Yinpeng Chen, Pengchuan Zhang, Dongdong Chen,
  Mengchen Liu, Jianfeng Wang, Zuxuan Wu, Lu Yuan, Yu-gang Jiang
conference: 2023 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)
year: 2023
bibkey: meng2022detection
citations: 10
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2206.03484'}]
tags: ["CVPR", "Datasets"]
short_authors: Meng et al.
---
Combining multiple datasets enables performance boost on many computer vision
