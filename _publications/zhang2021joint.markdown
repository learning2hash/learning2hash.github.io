...
title: Joint Learning Of Deep Retrieval Model And Product Quantization Based Embedding
  Index
authors: Zhang Han, Shen Hongwei, Qiu Yiming, Jiang Yunjiang, Wang Songlin, Xu Sulong,
  Xiao Yun, Long Bo, Yang Wen-yun
...
tags: ["Distance Metric Learning", "Quantization", "SIGIR", "Similarity Search", "Vector Indexing"]
