...
title: Joint Learning Of Deep Retrieval Model And Product Quantization Based Embedding
  Index
authors: Han Zhang, Hongwei Shen, Yiming Qiu, Yunjiang Jiang, Songlin Wang, Sulong
  Xu, Yun Xiao, Bo Long, Wen-Yun Yang
...
tags: [Evaluation, Similarity Search, Vector Indexing, Quantization, SIGIR]
