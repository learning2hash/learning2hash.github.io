...
authors: Yuan Yao, Ao Zhang, Xu Han, Mengdi Li, Cornelius Weber, Zhiyuan Liu, Stefan
  Wermter, Maosong Sun
conference: 2021 IEEE/CVF International Conference on Computer Vision (ICCV)
year: 2021
bibkey: yao2021visual
citations: 25
additional_links: [{name: Code, url: 'https://github.com/thunlp/VisualDS'}, {name: Paper,
    url: 'https://arxiv.org/abs/2103.15365'}]
tags: ["ICCV"]
