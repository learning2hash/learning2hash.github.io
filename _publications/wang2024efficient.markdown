...
authors: Jinpeng Wang, Niu Lian, Jun Li, Yuting Wang, Yan Feng, Bin Chen, Yongbing
  Zhang, Shu-tao Xia
conference: Arxiv
year: 2024
bibkey: wang2024efficient
citations: 0
additional_links: [{name: Code, url: 'https://github.com/gimpong/AAAI25-S5VH'}, {
    name: Paper, url: 'https://arxiv.org/abs/2412.14518'}]
