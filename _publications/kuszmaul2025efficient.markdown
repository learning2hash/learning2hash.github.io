...
authors: William Kuszmaul, Michael Mitzenmacher
conference: Proceedings of the 2025 Annual ACM-SIAM Symposium on Discrete Algorithms
  (SODA)
year: 2025
bibkey: kuszmaul2025efficient
citations: 1
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2501.02312'}]
tags: ["Efficiency", "Hashing Methods"]
short_authors: William Kuszmaul, Michael Mitzenmacher
---
...
offline setting: it says that, even though *negative* queries must take
