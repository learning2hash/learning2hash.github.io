...
title: 'Lightfr: Lightweight Federated Recommendation With Privacy-preserving Matrix
  Factorization'
authors: Zhang Honglei, Luo Fangyuan, Wu Jun, He Xiangnan, Li Yidong
...
tags: ["Hashing-Methods", "Efficiency", "Recommender-Systems", "Scalability", "Similarity-Search", "Tools-&-Libraries", "Datasets", "Compact-Codes"]
