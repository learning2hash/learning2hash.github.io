...
authors: Severo Daniel, Ottaviano Giuseppe, Muckley Matthew, Ullrich Karen, Douze
  Matthijs
conference: Arxiv
year: 2025
bibkey: severo2025lossless
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2501.10479'}]
tags: ["Graph-Based-Ann", "Quantization", "Vector-Indexing", "Scalability", "Memory-Efficiency", "Large-Scale-Search", "Datasets"]
