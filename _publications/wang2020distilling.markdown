...
tags: ["Distance Metric Learning", "Hashing Methods", "Locality Sensitive Hashing", "Neural Hashing", "Similarity Search"]
short_authors: Wang Guo-hua, Ge Yifan, Wu Jianxin
---
