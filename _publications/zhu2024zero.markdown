...
authors: Huilin Zhu, Jingling Yuan, Zhengwei Yang, Yu Guo, Zheng Wang, Xian Zhong,
  Shengfeng He
conference: Arxiv
year: 2024
bibkey: zhu2024zero
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2407.04948'}]
tags: ["Few Shot & Zero Shot"]
short_authors: Zhu et al.
---
Zero-shot object counting (ZOC) aims to enumerate objects in images using
