...
tags: [Applications, Quantization, Tools and Libraries, ANN Search, Multi-Modal Hashing,
  Evaluation Metrics, Loss Functions, Benchmarks and Datasets, Hashing Methods]
---
