...
authors: Guoyu Hu, Shaofeng Cai, Tien Tuan Anh Dinh, Zhongle Xie, Cong Yue, Gang Chen,
  Beng Chin Ooi
...
tags: [Evaluation, Similarity Search, Neural Hashing, Efficiency, Vector Indexing,
  Graph-based ANN, Datasets]
