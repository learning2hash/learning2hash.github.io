...
title: 'NEAR\(^2\): A Nested Embedding Approach To Efficient Product Retrieval And
  Ranking'
authors: Shenbin Qian, Diptesh Kanojia, Samarth Agrawal, Hadeel Saadany, Swapnil Bhosale,
  Constantin Orasan, Zhe Wu
conference: Arxiv
year: 2025
bibkey: qian2025near
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2506.19743'}]
tags: [Distance Metric Learning, Evaluation, Efficiency]
