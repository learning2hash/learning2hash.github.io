...
title: 'All You Can Embed: Natural Language Based Vehicle Retrieval With Spatio-temporal
  Transformers'
authors: Scribano Carmelo, Sapienza Davide, Franchini Giorgia, Verucchi Micaela, Bertogna
  Marko
...
citations: 7
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2106.10153'}]
tags: ["CVPR", "Image Retrieval", "Multimodal Retrieval", "Similarity Search", "Text Retrieval"]
