...
title: 'V\(^2\)L: Leveraging Vision And Vision-language Models Into Large-scale Product
  Retrieval'
authors: Wang Wenhao, Sun Yifan, Yang Zongxin, Yang Yi
conference: Arxiv
year: 2022
bibkey: wang2022v
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2207.12994'}]
tags: ["Self-Supervised", "Distance-Metric-Learning", "Image-Retrieval", "Scalability", "Supervised"]
