...
authors: Licheng Tang, Yiyang Cai, Jiaming Liu, Zhibin Hong, Mingming Gong, Minhu
  Fan, Junyu Han, Jingtuo Liu, Errui Ding, Jingdong Wang
conference: 2022 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)
year: 2022
bibkey: tang2022few
citations: 53
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2205.09965'}]
tags: ["CVPR", "Few Shot & Zero Shot"]
short_authors: Tang et al.
---
Few-shot font generation (FFG), which aims to generate a new font with a few
