...
authors: Man Zhou, Hu Yu, Jie Huang, Feng Zhao, Jinwei Gu, Chen Change Loy, Deyu Meng,
  Chongyi Li
conference: Arxiv
year: 2022
bibkey: zhou2022deep
citations: 26
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2210.05171'}]
tags: []
short_authors: Zhou et al.
---
Existing convolutional neural networks widely adopt spatial down-/up-sampling
for multi-scale modeling. However, spatial up-sampling operators (*e.g.*,
