...
authors: Song Jonghyun, Jin Cheyon, Zhao Wenlong, Mccallum Andrew, Lee Jay-yoon
...
tags: ["EMNLP", "Tools-&-Libraries", "Datasets", "Re-Ranking", "Evaluation"]
...
linking (+0.7%-p) and DSTC7 dialogue ranking (+3.3%-p).