---
layout: publication
title: 'Visual DNA: Representing And Comparing Images Using Distributions Of Neuron
  Activations'
authors: Benjamin Ramtoula, Matthew Gadd, Paul Newman, Daniele de Martini
conference: 2023 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)
year: 2023
bibkey: ramtoula2023visual
citations: 7
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2304.10036'}]
tags: ["CVPR"]
short_authors: Ramtoula et al.
---
Selecting appropriate datasets is critical in modern computer vision.
