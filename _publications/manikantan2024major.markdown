...
conference: Proceedings of the 2024 Conference on Empirical Methods in Natural Language
  Processing
year: 2024
bibkey: manikantan2024major
citations: 1
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2406.14654'}]
tags: ["EMNLP"]
short_authors: Manikantan et al.
---
The limited generalization of coreference resolution (CR) models has been a
