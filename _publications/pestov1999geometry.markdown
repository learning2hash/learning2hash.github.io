---
layout: publication
title: 'On The Geometry Of Similarity Search: Dimensionality Curse And Concentration
  Of Measure'
...
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/cs/9901004'}]
...
in \\(X\\) and \\(n\\) is the dimension of \\(Ω\\).