...
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2410.19213'}]
tags: ["Datasets", "Evaluation", "Few-shot & Zero-shot", "Hashing Methods", "Neural Hashing"]
short_authors: Zheng et al.
---
In this paper, we study a practical yet challenging task, On-the-fly Category
