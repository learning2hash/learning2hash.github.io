...
tags: [Compact Codes, Hashing Methods, SIGIR, Memory Efficiency, Supervised, Unsupervised,
  Scalability, Evaluation, Quantization, Tools & Libraries]
