---
layout: publication
title: 'Deeptaster: Adversarial Perturbation-based Fingerprinting To Identify Proprietary
  Dataset Use In Deep Neural Networks'
authors: Seonhye Park, Alsharif Abuadbba, Shuo Wang, Kristen Moore, Yansong Gao, Hyoungshick
  Kim, Surya Nepal
conference: In Proceedings of the 39th Annual Computer Security Applications Conference
  pp. 535-549. 2023
year: 2022
bibkey: park2022deeptaster
citations: 0
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2211.13535'}]
tags: ["Robustness"]
short_authors: Park et al.
---
Training deep neural networks (DNNs) requires large datasets and powerful
