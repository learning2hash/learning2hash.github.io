...
authors: Pisov Maxim, Makarchuk Gleb, Kostjuchenko Valery, Dalechina Alexandra, Golanov
  Andrey, Belyaev Mikhail
conference: Arxiv
year: 2018
bibkey: pisov2018brain
citations: 5
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1810.09369'}]
tags: ["Distance Metric Learning", "Image Retrieval", "Medical Retrieval", "Multitask Learning"]
