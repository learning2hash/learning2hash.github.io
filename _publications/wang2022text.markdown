...
authors: Wang Liang, Yang Nan, Huang Xiaolong, Jiao Binxing, Yang Linjun, Jiang Daxin,
  Majumder Rangan, Wei Furu
conference: Arxiv
year: 2022
bibkey: wang2022text
citations: 74
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2212.03533'}]
tags: ["Datasets", "Evaluation", "Few-shot & Zero-shot", "Self-Supervised", "Supervised", "Unsupervised"]
