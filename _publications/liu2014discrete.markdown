...
authors: W. Liu, Mu, Kumar, Chang
conference: No Venue
year: 2014
bibkey: liu2014discrete
citations: 496
additional_links: [{name: Paper, url: 'http://www.ee.columbia.edu/~wliu/NIPS14_dgh.pdf'}]
tags: ["Compact Codes", "Datasets", "Efficiency", "Evaluation", "Graph Based ANN", "Hashing Methods", "Neural Hashing", "Supervised", "Tools & Libraries", "Unsupervised"]
