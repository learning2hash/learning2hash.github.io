...
authors: Fran Silavong, Moran, Georgiadis, Saphal, Otter
conference: Arxiv
year: 2021
bibkey: silavong2021deskew
citations: 1
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2111.04473'}]
tags: [Neural Hashing, Scalability, Datasets, Efficiency, Tree-based ANN, Hashing
    Methods, Locality Sensitive Hashing, Recommender Systems, Evaluation]
