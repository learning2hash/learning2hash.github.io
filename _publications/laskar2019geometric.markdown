...
authors: Laskar Zakaria, Melekhov Iaroslav, Tavakoli Hamed R., Ylioinas Juha, Kannala
  Juho
...
tags: ["Distance-Metric-Learning", "Image-Retrieval", "Datasets", "Re-Ranking", "Hybrid-Ann-Methods"]
