...
authors: Kannan Shyam Sundar, Min Byung-cheol
...
tags: ["Datasets", "Efficiency", "Evaluation", "Image Retrieval", "Transformer-based ANN"]
short_authors: Kannan Shyam Sundar, Min Byung-cheol
---
