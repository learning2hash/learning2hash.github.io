...
---
We introduce a novel problem, i.e., the localization of an input image within a
multi-modal reference map represented by a database of 3D scene graphs. These
...
three orders-of-magnitude less storage and operating orders-of-magnitude faster.
