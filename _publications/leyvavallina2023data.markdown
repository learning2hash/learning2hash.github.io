...
authors: Leyva-vallina Maria, Strisciuglio Nicola, Petkov Nicolai
conference: 2023 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)
year: 2023
bibkey: leyvavallina2023data
citations: 24
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2303.11739'}]
tags: ["CVPR", "Datasets", "Distance Metric Learning", "Efficiency", "Hybrid ANN Methods", "Image Retrieval", "Re-ranking", "Scalability", "Similarity Search"]
short_authors: Leyva-vallina Maria, Strisciuglio Nicola, Petkov Nicolai
---
