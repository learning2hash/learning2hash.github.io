...
title: Modeling Text With Graph Convolutional Network For Cross-modal Information
  Retrieval
authors: Jing Yu, Yuhang Lu, Zengchang Qin, Yanbing Liu, Jianlong Tan, Li Guo, Weifeng
  Zhang
...
tags: ["Graph Based ANN", "Image Retrieval", "Multimodal Retrieval", "Text Retrieval"]
